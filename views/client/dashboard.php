...
<section class="recommendations">
    ...
    <?php if (!empty($services)): ?>
        <?php foreach ($services as $service):
            $imagePath = !empty($service['media_path']) ? '/public/uploads/' . $service['media_path'] : '/public/photos/default-service.jpg';
        ?>
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <p><strong>Rating:</strong> <?= number_format($service['rating'], 1) ?> ⭐</p>
    ...
    <div class="job-grid">
        <?php while ($job = $jobs->fetch_assoc()): ?>
            <div class="job-card">
                ...
                <p><strong>Posted:</strong> <?php echo Job::formatTimeSincePost($job['posted_at']); ?></p>
